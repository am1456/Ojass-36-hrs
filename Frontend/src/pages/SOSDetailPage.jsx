                        ...
                        <div className="card p-5 border-blue-500/15">
                            <div className="flex items-center gap-2.5 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600 text-xs">Generated by Gemini</p>
                                </div>
                            </div>
                            <div className="text-slate-400 text-sm leading-relaxed whitespace-pre-wrap"
                                style={{ borderLeft: '2px solid rgba(59,130,246,0.3)', paddingLeft: '1rem' }}>
                                {typeof aiGuidance === 'object' && aiGuidance.guidance
                                    ? aiGuidance.guidance
                                    : typeof aiGuidance === 'string'
                                        ? aiGuidance
                                        : JSON.stringify(aiGuidance, null, 2)
                                }
                            </div>
                        </div>
                    )}
                ...
                <div className="lg:col-span-2 card flex flex-col" style={{ height: 'calc(100vh - 96px)' }}>
                    ...
                    {!isResolved && (
                        <form onSubmit={sendChat} className="p-3 flex gap-2"
                            ...
                            <button type="submit"
                                className="flex items-center justify-center w-9 h-9 rounded-lg bg-accent hover:bg-rose-600 text-white transition-colors flex-shrink-0">
                                <Send size={14} />
                            </button>
                        </form>
                    )}
